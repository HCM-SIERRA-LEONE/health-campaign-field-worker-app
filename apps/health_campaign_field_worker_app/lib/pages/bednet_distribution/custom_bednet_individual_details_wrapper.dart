...
import '../registration_deliver_pages/beneficiary_registration/custom_individual_details.dart';

@RoutePage()
class CustomBednetIndividualDetailsWrapperPage extends StatelessWidget
  ...
  const CustomBednetIndividualDetailsWrapperPage({
    super.key,
  ...
  Widget build(BuildContext context) {
    return CustomIndividualDetailsPage(
      isHeadOfHousehold: isHeadOfHousehold,
    );
  }
}
